...
![Layout Example](cute-layout/layout_example.jpg)
...
![Complement Example](cute-layout/complement1.png)
...
![Divide Example 1](cute-layout/divide1.png)
...
![2D Logical Divide](cute-layout/divide2.png)
...
![1D Logical Product 1](cute-layout/product1.png)

![1D Logical Product 2](cute-layout/product2.png)
...
![2D Logical Product](cute-layout/product2d.png)

CuTe 提供了 `blocked_product` 和 `raked_product`，来简化这样的乘法操作。

![Blocked Product](cute-layout/productblocked2d.png)

Blocked product 把 Layout A 连续的按照 Layout B 进行排布。

![Raked Product](cute-layout/productraked2d.png)
